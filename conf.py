...
gogh_configs = [
    StyleTransferConfiguration(
        ...
        numiter=100,
        writeevery=10,
        content_layers=('conv_9', 'conv_10'),
        style_layers=('conv_5', 'conv_10'),
        style_weight=1000000,
        content_weight=10,
        optimizer='LBFGS'
    ),
    StyleTransferConfiguration(
        ...
        numiter=100,
        writeevery=10,
        content_layers=('conv_9', 'conv_16'),
        style_layers=('conv_5', 'conv_8'),
        style_weight=10000000,
        content_weight=10,
        optimizer='LBFGS'
    ),
    StyleTransferConfiguration(
        ...
        numiter=100,
        writeevery=10,
        content_layers=('conv_5', 'conv_8'),
        style_layers=('conv_9', 'conv_14'),
        style_weight=1000000,
        content_weight=10,
        optimizer='LBFGS'
    ),
